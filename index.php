  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      background-image: url(https://res.cloudinary.com/yeungon/image/upload/v1626080735/background/bg2.jpg);
  ...
  <main>
    ...
    do {
      ...
      foreach ($data as $datium) {
        ...
        $notice = property_exists($datium->fields, "notices") ? $datium->fields->notices : "all good!";
        $st = property_exists($datium->fields, "status") ? $datium->fields->status : "pending";


        $users[] = [$addess => [$st, $notice]];
      }
      ...
      echo "<th>Email </th>";
      echo "<th>Status</th>";
      echo "<th class = 'notices__head'>Notice</th>";
      echo "</tr>";

      $x = 0;

      foreach ($users as $user) {
        foreach ($user as $key => $valueArray) {
          $x++;

          $value = $valueArray[0];
          $noticeDisplay = $valueArray[1];
          ...
          echo "<td><span class = 'notices__data'>${noticeDisplay}</span></td>";
          echo "</tr>";
        }
      }
      echo "</table>";
    ...
    <section id="moon">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72">
        ...
        <path d="M10 7a7 7 0 0 0 12 4.9v.1c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2h.1A6.979 6.979 0 0 0 10 7zm-6 5a8 8 0 0 0 15.062 3.762A9 9 0 0 1 8.238 4.938 7.999 7.999 0 0 0 4 12z" fill="rgba(255,255,255,1)" />
      </svg>
      </svg>
    </section>
  </main>
